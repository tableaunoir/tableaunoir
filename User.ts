...
export class User {
    ...
    switchChalk(): void { this.tool.destructor(); this.tool = new ToolDraw(this); document.getElementById("gauge").setAttribute('style', 'display: none'); }
    switchErase(): void { this.tool.destructor(); this.tool = new ToolEraser(this); document.getElementById("gauge").setAttribute('style', 'display: inline-block'); }
    switchLine(): void { this.tool.destructor(); this.tool = new ToolLine(this); document.getElementById("gauge").setAttribute('style', 'display: none'); }
    switchRectangle(): void { this.tool.destructor(); this.tool = new ToolRectangle(this); document.getElementById("gauge").setAttribute('style', 'display: none'); }
    switchEllipseByBorder(): void { this.tool.destructor(); this.tool = new ToolEllipseByBorder(this); document.getElementById("gauge").setAttribute('style', 'display: none'); }
    switchEllipseByCenter(): void { this.tool.destructor(); this.tool = new ToolEllipseByCenter(this); document.getElementById("gauge").setAttribute('style', 'display: none'); }
    switchArc(): void { this.tool.destructor(); this.tool = new ToolArc(this); document.getElementById("gauge").setAttribute('style', 'display: none'); }
